...
addon_id = 'plugin.video.adrxbmcmais18'
...
class Viewer:
	def __init__( self, *args, **kwargs ):
		if sys.argv[1] == "changelog":
			...
			try:
				codigo_fonte=self.abrir_url('http://anonymous-repo.googlecode.com/svn/trunk/anonymous-repo-adults/plugin.video.adrxbmcmais18/addon.xml')
